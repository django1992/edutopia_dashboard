...
(function (global) {
  ...
  // Días entre dos fechas ISO ("YYYY-MM-DD"), ambas inclusive -- para normalizar totales de
  // un mes en curso (parcial) a un "promedio por día" comparable contra un mes ya completo.
  ...
  global.yesterdayISO = yesterdayISO;
  global.daysBetweenISO = daysBetweenISO;
})(window);
